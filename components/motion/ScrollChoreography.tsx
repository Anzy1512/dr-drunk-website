...
export function ScrollChoreography() {
  useEffect(() => {
    ...
    media.add("(prefers-reduced-motion: no-preference)", () => {
      ...
      document.querySelectorAll<HTMLElement>(".section-heading h2, .illustrated-heading h2").forEach((heading) => gsap.from(heading, { y: 35, rotation: -1.5, opacity: 0.35, ease: "power2.out", scrollTrigger: { trigger: heading, start: "top 95%", end: "top 70%", scrub: 0.65 } }));
