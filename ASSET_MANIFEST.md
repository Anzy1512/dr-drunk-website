...
All remaining supplied images were reviewed and retained in the internal source inventory; they are not automatically published. No unrelated generated imagery, external model or unlicensed embedded font is used. Logo and photo crops are production derivatives authorized by the brief's extraction/optimization requirements. No source PDF is republished by default.
