...
|---|---|
| Inspect every source before implementation | All 51 PDF pages and 50 photographs reviewed; BRAND_ANALYSIS.md, ASSET_MANIFEST.md and docs/source-inventory.json record the findings. |
| Establish visual grammar and architecture | 3D_LANGUAGE.md and EXPERIENCE_ARCHITECTURE.md describe source-derived geometry, motion, hierarchy and routes. |
| Include the complete supplied information | docs/CONTENT_COVERAGE.md maps all four decks; the catalogue includes 100 source rows in ten categories, the gallery includes all 50 photographs, and original PDFs preserve the full boards and reference links. |
| Multipage experience | Home, Cocktails, Weddings, Experiences, Gallery, About and Contact, with reliable native navigation and page metadata. |
| Deck branding and lighter floating background | Original logo and geometric pattern, cream/amber/orange palette, Bebas Neue/Poppins/Caveat, low-opacity cocktail illustrations and glass bubbles. |
| Interactive glass menu and hover treatments | GSAP sliding navigation highlight, rolling text, glass mobile navigation, pointer-responsive illustration cards and photo frames, button and gallery hover states. |
| 21st.dev inspiration | Reference patterns reviewed and documented in MOTION_REFERENCES.md; implementations are original adaptations, not copied or installed third-party component source. |
| Stronger Three.js and JavaScript animation | Physical coupe, stethoscope, citrus wheel, mint, instanced carbonation and shader-based liquid shimmer; pointer response and scroll-directed camera orbit. |
| Funkier composition and fuller sparse areas | Amber prescription stamp, compact menu note, illustrated practice cards and angled typographic ribbon. |
| Scrolling animation | GSAP ScrollTrigger controls the scene, horizontal ribbon, staggered cards, heading reveals, photo parallax and reading progress. Native vertical scrolling remains intact. |
| Illustrations and motion | Four original SVG illustration families, line-drawing entrances, ambient drift and garnish hover animation. |
